...
class PodcastEpisodes:
    ...
    def get_podcast_episodes(self, request: operations.GetPodcastEpisodesRequest) -> operations.GetPodcastEpisodesResponse:
        ...
        res = operations.GetPodcastEpisodesResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[list[shared.PodcastEpisodeIndex]])
