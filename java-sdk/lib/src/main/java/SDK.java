...
public class Forem {
	...
	public static class Builder {
		...
		public Forem build() throws Exception {
			return new Forem(this.client, this.security, this.serverUrl, this.params);
		}
	}
	...
	private Forem(HTTPClient client, .models.shared.Security security, String serverUrl, java.util.Map<String, String> params) throws Exception {
